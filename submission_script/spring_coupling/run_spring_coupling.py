...
gamma = 8
motor = DiffusionJumpMotor(k_attach_right_FTC = k_attach_right_FTC, epR = epR, E_C_track = E_C_track,coupling_strength=spring_strength,shifted_distance=shifted_distance,barrier_height=barrier_height,gamma = gamma)
